...
const Register = () => {
    ...
    return ( <>
        <form onSubmit={submit} className="formy">
            <h2>Register</h2>
            <input required className="formyt" type="text" placeholder="enter your name" onChange={ (e)=>setUser({...user,name:e.target.value}) }/>
            <input required className="formyt" type="email" placeholder="enter your email" onChange={ (e)=>setUser({...user,email:e.target.value}) }/>
            <input required className="formyt" type="password" placeholder="enter your password" onChange={ (e)=>{setUser({...user,password:e.target.value}); setPass1(e.target.value)}}/>
            <input required className="formyt" type="password" placeholder="confinrm your password" onChange={ (e)=>{setPass2(e.target.value)}}/>
